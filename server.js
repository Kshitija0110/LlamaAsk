...
const mongoURI =
  "mongodb+srv://kshitudeshmukh3:kshitu123@genai.x4ney.mongodb.net/qa_db?retryWrites=true&w=majority&appName=GenAI";
...
app.post("/ask", async (req, res) => {
  ...
  try {
    ...
    const pythonResponse = await fetch(
      "https://huggingface.co/spaces/Kshitu/AskGen",
      {
        method: "POST",
